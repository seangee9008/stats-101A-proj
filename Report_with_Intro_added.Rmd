...
- **Median.Hourly.Gap**: The difference between the mean hourly remuneration of employees of the male gender and that of employees of the female gender expressed as a percentage of the mean hourly remuneration of employees of the male gender  
...
&nbsp;
  ...
  This study reports summary statistics of all utilized variables, scatterplot matrices, diagnostic plots, and density plots. Our data was initially fitted using a generalized full model. However, through a series of descriptive tests, we saw that the relationship between mean pay gap and gender/year lacks heteroscedasticity. To mitigate this issue our team used a weighted least squares (WLS) regression model to preserve constant variance. Effectively, this allowed us to better understand the relationship between pay gaps among different Irish companies while taking into account gender and year. Ultimately, we unveiled that gender was statistically significant to mean pay gaps, whereas year was not. These results provide modern insights into the persistence of gender-based pay disparities across Irish companies.
