...
full_model<- lm(Mean.Hourly.Gap ~ Report.Year+Q1.Female+Q2.Female+Q3.FemaleQ4.Female, data = new_data)
...
```{r}
df_cleaned$Mean.Hourly.Gap <- (df_cleaned$Mean.Hourly.Gap)^(2/5)
